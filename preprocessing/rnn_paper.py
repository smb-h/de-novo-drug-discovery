...
# Constants
FP_PROCESSING_FIXED = {"start_char": "G", "end_char": "E", "pad_char": "A"}
...
# make the UMAP plot.
FP_UMAP_PLOT = {"n_dataset": 1000, "n_gen": 1000}
...
def hp_chem_cleanup_smiles(
    all_mols, salt_removal=True, stereochem=False, canonicalize=True
):
...
if __name__ == "__main__":
    ...
    do_processing(
        split, full_data_path, aug, min_len, max_len, "./rnn.txt", verbose=verbose
    )
