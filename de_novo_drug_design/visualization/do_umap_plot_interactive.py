...
parser.add_argument(
    "-fn", "--filename", type=str, help="Path to the fine-tuning txt file", required=True
)
...
if __name__ == "__main__":
    ...
    if check_epoch == 40 and check_period == 10:
        ...
        df_tgt = get_dataframe(smiles_tgt, embedding[lim_src:lim_tgt, :], "Target space")

        df_start = get_dataframe(smiles_start, embedding[lim_tgt:lim_start, :], "First epoch")

        df_end = get_dataframe(smiles_end, embedding[lim_start:lim_end, :], "Last epoch")
